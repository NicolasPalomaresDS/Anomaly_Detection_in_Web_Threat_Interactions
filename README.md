...
* `scripts/`: Custom Python scripts.
    - `kaggle_setup.py`: For data download and Kaggle configuration.
    - `df_summary.py`: For a complete dataset summary generation.
    - `baseline_model.py`: Script with baseline model class.
